...
// GET LOCATION PERMISSIONS //
  hasLocationPermission = async () => {
    ...
    if (status === PermissionsAndroid.RESULTS.DENIED) {
      ...
      ToastAndroid.show(
        'Location Access Revoked By User.',
        ToastAndroid.LONG,
      );
    }
    return false;
...
// SET LOCATION //
  ...
  render(){
    return (
      ...
      {/*READY FORM INPUT*/}
        <Text style={{marginBottom:40, fontSize:20, fontWeight:'bold', color:"#02a8a8"}}>LOGIN</Text>
      ...
      {/*READY BUTTON SUBMIT*/}
          ...
          >
            <Text style={{color: '#414959', fontSize: 13}}>
              Try Now! <Text style={{color: '#02a8a8', fontWeight: '500'}}>Register</Text>
            </Text>
          </TouchableOpacity>
        </ImageBackground>
      </>
