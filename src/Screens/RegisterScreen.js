...
import bgImage from '../Assets/Images/bgImagecat.jpg'
import loadingLogo from '../Assets/Images/cat-chat.jpg'
...
// POST SIGNUP //
  ...
  handleRegister = () => {
    ...
    if (name.length < 1) {
      ToastAndroid.show('Please input your name', ToastAndroid.LONG);
        ...
        .then(response => {
          ...
          Database.ref('/user/' + response.user.uid)
            .set({
              ...
              photo: 'https://res.cloudinary.com/metagenes/image/upload/v1576147783/default_u7uctp.png',
            ...
            ToastAndroid.show ('Welcome to CatChat', ToastAndroid.LONG,);
            Database.ref('user/')
              .orderByChild('/email')
              .equalTo(email)
              .once('value', result => {
  ...
  render(){
    return (
      ...
      <Text style={{marginBottom:40, fontSize:20, fontWeight:'bold', color:"#02a8a8"}}>Register</Text>
      ...
      {/*READY BUTTON SUBMIT*/}
          ...
          >
            <Text style={{color: '#414959', fontSize: 13}}>
              Already Have an Account? <Text style={{color: '#02a8a8', fontWeight: '500'}}>Login Now</Text>
            </Text>
          </TouchableOpacity>
          </ImageBackground>
      </>
